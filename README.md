...
| `--mic-names` | — | one name per mic, in order: each mic belongs to that person → **hardware speaker attribution** (loudest mic per word owns it, always); ≥2 mics default to letters |
